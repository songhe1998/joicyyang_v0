...
export default function Gallery() {
  ...
  const images = Array.from({ length: 15 }, (_, i) => ({
    ...
    src: `/images/gallery/gallery-photo-${String(i + 1).padStart(2, "0")}.png`,
  }))
      ...
      <header className="bg-gray-100 p-8">
        ...
        <nav className="bg-teal-700 px-6 py-4 rounded">
          <ul className="flex space-x-8 text-white">
            ...
            <li>
              <a href="/gallery" className="text-yellow-400">
                Gallery
              </a>
            </li>
            <li>
      ...
      <main className="flex">
        <div className="flex-1 px-8 py-12">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-5xl font-light text-teal-700 mb-12">Gallery</h2>
